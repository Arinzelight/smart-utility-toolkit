...
import { StyleSheet, View, ScrollView, ActivityIndicator, Pressable, Modal, FlatList } from 'react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <View style={styles.selectors}>
            <View style={styles.selectorWrapper}>
              ...
              >
                <Text style={{ color: theme.text }}>
                  <Text style={{ fontSize: 16 }}>{getCurrencyFlag(fromCurrency)}</Text> {fromCurrency}
                </Text>
            ...
            <View style={styles.selectorWrapper}>
              ...
              >
                <Text style={{ color: theme.text }}>
                  <Text style={{ fontSize: 16 }}>{getCurrencyFlag(toCurrency)}</Text> {toCurrency}
                </Text>
                <ChevronDown size={16} color={theme.textSecondary} />
              </Pressable>
            </View>
        ...
        >
          <View style={styles.modalOverlay}>
            ...
            <View style={[styles.bottomSheet, { backgroundColor: theme.card, paddingBottom: Math.max(insets.bottom, Spacing.lg) }]}>
              <Text variant="titleMedium" style={[styles.sheetTitle, { color: theme.text }]}>Select From Currency</Text>
              <FlatList
        ...
        >
          <View style={styles.modalOverlay}>
            ...
            <View style={[styles.bottomSheet, { backgroundColor: theme.card, paddingBottom: Math.max(insets.bottom, Spacing.lg) }]}>
              <Text variant="titleMedium" style={[styles.sheetTitle, { color: theme.text }]}>Select To Currency</Text>
              <FlatList
                data={availableCurrencies}
                keyExtractor={(item) => item}
                bounces={false}
